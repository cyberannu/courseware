...
if ( nd_learning_get_course_availability($nd_learning_id) == 0 ) {
    $nd_learning_course_button = '
        <a class="nd_learning_bg_greydark nd_learning_display_inline_block nd_learning_color_white_important nd_options_first_font nd_learning_padding_8 nd_learning_border_radius_4 nd_learning_font_size_13" href="'.$nd_learning_permalink.'">'.__('COMPLETED','nd-learning').'</a>
    '; 
}else{
    ...
    $nd_learning_course_button = '
        <a class="nd_learning_display_inline_block nd_learning_bg_greydark nd_learning_color_white_important nd_options_first_font nd_learning_padding_8 nd_learning_border_radius_4 nd_learning_font_size_13" href="'.$nd_learning_permalink.'">'.$nd_learning_course_price.'</a>
    ';  
        ...
        <div class="nd_learning_section">
            ...
            <div class="nd_learning_section nd_learning_border_1_solid_grey nd_learning_border_radius_4">
                ...
                <div class="nd_learning_section nd_learning_padding_20 nd_learning_box_sizing_border_box nd_learning_bg_white">
                    ...
                    <h3 class="nd_learning_font_weight_normal"><a class="nd_options_color_greydark nd_options_first_font" href="'.$nd_learning_permalink.'">'.$nd_learning_title.'</a></h3>
                    <div class="nd_learning_section nd_learning_height_5"></div>
                    <p>'.__('By','nd-learning').' '.$nd_learning_teacher_name.'</p>
                ...
                <div class="nd_learning_section nd_learning_padding_20 nd_learning_box_sizing_border_box nd_learning_border_top_1_solid_grey">
                    ...
                    <div class="nd_learning_width_50_percentage nd_learning_float_left">
                        <div class="nd_learning_display_table nd_learning_float_left">
                            ...
                            <p class="nd_learning_display_table_cell nd_learning_vertical_align_middle nd_learning_font_size_15"><a href="'.$nd_learning_permalink.'">'.nd_learning_get_course_category().'</a></p>
                        </div>
                    </div> 
