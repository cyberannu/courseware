...
if ( $nd_learning_image_attributes[0] == '' ) { $nd_learning_output_image = ''; }else{
  $nd_learning_output_image = '
    ...
    <div class="nd_learning_bg_greydark_alpha_gradient_2 nd_learning_position_absolute nd_learning_left_0 nd_learning_height_100_percentage nd_learning_width_100_percentage nd_learning_padding_20 nd_learning_box_sizing_border_box">
        ...
        //bookmark function
        if (function_exists('nd_learning_add_bookmark_button')) {  $nd_learning_output_image .= nd_learning_add_bookmark_button(); }
        //compare function
        if (function_exists('nd_learning_add_compare_button')) {  $nd_learning_output_image .= nd_learning_add_compare_button(); }


        $nd_learning_output_image .= '</div>    
        ...
        <div class="nd_learning_position_absolute nd_learning_bottom_20">
            ...
            <h2 class="nd_learning_color_white_important nd_learning_display_none_all_iphone">
                <a class="nd_learning_color_white_important nd_options_first_font" href="'.$nd_learning_permalink.'">
                    '.$nd_learning_title.'
                </a>
            </h2>
            ...
            <div class="nd_learning_display_table nd_learning_float_left nd_learning_margin_right_20">
                ...
                <div class="nd_learning_display_table_cell nd_learning_vertical_align_middle">
                    <img alt="" class="nd_learning_float_left nd_learning_margin_right_10 nd_learning_display_table_cell nd_learning_vertical_align_middle" width="20" src="'.esc_url(plugins_url('icon-calendar-white.svg', __FILE__ )).'">
                </div>

                <div class="nd_learning_display_table_cell nd_learning_vertical_align_middle">
                    <p class="nd_learning_color_white_important nd_learning_display_table_cell nd_learning_vertical_align_middle nd_learning_font_size_13">'.nd_learning_get_course_date().'</p>
                </div>
            ...
            <div class="nd_learning_display_table nd_learning_float_left">
                ...
                <div class="nd_learning_display_table_cell nd_learning_vertical_align_middle">
                    <img alt="" class="nd_learning_float_left nd_learning_margin_right_10 nd_learning_display_table_cell nd_learning_vertical_align_middle" width="20" src="'.esc_url(plugins_url('icon-clock-white.svg', __FILE__ )).'">
                </div>

                <div class="nd_learning_display_table_cell nd_learning_vertical_align_middle">
                    <p class="nd_learning_color_white_important nd_learning_display_table_cell nd_learning_vertical_align_middle nd_learning_font_size_13">'.nd_learning_get_course_duration().'</p>
                </div>
        ...
        <div class="nd_learning_section">
            ...
            <div class="nd_learning_section nd_learning_border_1_solid_grey">
                ...
                <div class="nd_learning_section nd_learning_padding_20 nd_learning_box_sizing_border_box nd_learning_bg_white">
                    ...
                    <h3><a class="nd_options_color_greydark nd_options_first_font" href="'.$nd_learning_permalink.'">'.nd_learning_get_course_category().'</a></h3>
                ...
                <div class="nd_learning_section nd_learning_padding_20 nd_learning_box_sizing_border_box nd_learning_bg_grey nd_learning_border_top_1_solid_grey">
                    ...
                    <div class="nd_learning_width_33_percentage nd_learning_width_50_percentage_all_iphone nd_learning_float_left">
                        <div class="nd_learning_display_table nd_learning_float_left">
                            <img alt="" class="nd_learning_margin_right_10 nd_learning_display_table_cell nd_learning_vertical_align_middle" width="23" src="'.esc_url(plugins_url('icon-availability.svg', __FILE__ )).'">
                            <p class="nd_learning_display_table_cell nd_learning_vertical_align_middle nd_learning_font_size_15"><a href="'.$nd_learning_permalink.'">'.nd_learning_get_course_availability($nd_learning_id).' '.__('Seats','nd-learning').'</a></p>
                        </div>
                    </div> 
