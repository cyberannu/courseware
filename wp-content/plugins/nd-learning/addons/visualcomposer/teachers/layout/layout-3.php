	...
	<div class=" '.$nd_learning_width.' nd_learning_padding_15 nd_learning_box_sizing_border_box nd_learning_masonry_item nd_learning_width_100_percentage_responsive">
	    <div class="nd_learning_section nd_learning_box_sizing_border_box">
	        ...
	        <div class="nd_learning_section nd_learning_position_relative">
	            ...
	            <div class="nd_learning_bg_greydark_alpha_gradient_3_2 nd_learning_position_absolute nd_learning_left_0 nd_learning_height_100_percentage nd_learning_width_100_percentage nd_learning_box_sizing_border_box">
	                ...
	                <div class="nd_learning_position_absolute nd_learning_bottom_30 nd_learning_width_100_percentage nd_learning_padding_bottom_0 nd_learning_padding_50 nd_learning_box_sizing_border_box nd_learning_text_align_center">
	                    ...
	                    <h6 class="nd_learning_text_transform_uppercase nd_learning_color_white_important">'.$nd_learning_meta_box_teacher_role.'</h6>

	                    <div class="nd_learning_section nd_learning_height_20"></div>

	                    <p class="nd_learning_color_white_important nd_learning_display_none_all_iphone">'.$nd_learning_excerpt.'</p>
	                    
	                    <div class="nd_learning_section nd_learning_height_20 nd_learning_display_none_all_iphone"></div>
