...
if ( $nd_learning_image_attributes[0] == '' ) { $nd_learning_output_image = ''; }else{
  $nd_learning_output_image = '<img class="nd_learning_section nd_learning_border_radius_4_4_0_0" alt="" src="'.$nd_learning_image_attributes[0].'">';
}
...
//social
$nd_learning_social_teacher_output = '<div class="nd_learning_border_radius_0_0_4_4 nd_learning_pg_teachers_l5_social nd_learning_padding_10_0_5_0 nd_learning_section nd_learning_bg_greydark nd_learning_text_align_center"><div class="nd_learning_display_inline_block">';
	...
	<div class=" '.$nd_learning_width.' nd_learning_padding_15 nd_learning_box_sizing_border_box nd_learning_masonry_item nd_learning_width_100_percentage_responsive">
	    ...
	    <div class="nd_learning_section">
	        ...
	        <div class="nd_learning_section ">
	            ...
	            <div class="nd_learning_section nd_learning_padding_20 nd_learning_box_sizing_border_box nd_learning_text_align_center">
	            
	                <h2 class="nd_learning_font_weight_normal">'.$nd_learning_title .'</h2>
	                <div class="nd_learning_section nd_learning_height_10"></div> 
	                <h6 class="nd_learning_text_transform_uppercase nd_options_color_grey nd_options_second_font nd_learning_font_weight_normal">'.$nd_learning_meta_box_teacher_role.'</h6>
	                <div class="nd_learning_section nd_learning_height_20"></div> 
	                <a style="background-color: '.$nd_learning_meta_box_teacher_color.';" class="nd_learning_display_inline_block nd_learning_color_white_important nd_options_first_font nd_learning_padding_8_15 nd_learning_border_radius_4 nd_learning_font_size_13" href="'.$nd_learning_permalink.'">'.__('VIEW PROFILE','nd-learning').'</a>
