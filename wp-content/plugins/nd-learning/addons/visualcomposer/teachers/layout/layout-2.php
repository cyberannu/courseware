...
if ( $nd_learning_meta_box_teacher_social_facebook == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_facebook.'"><img alt="" width="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.esc_url(plugins_url('facebook.svg', __FILE__ )).'"></a>';
}
//twitter
...
if ( $nd_learning_meta_box_teacher_social_twitter == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_twitter.'"><img alt="" width="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.esc_url(plugins_url('twitter.svg', __FILE__ )).'"></a>';
}
...
if ( $nd_learning_meta_box_teacher_social_instagram == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_instagram.'"><img alt="" width="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.esc_url(plugins_url('instagram.svg', __FILE__ )).'"></a>';
}
...
if ( $nd_learning_meta_box_teacher_social_pinterest == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_pinterest.'"><img alt="" width="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.esc_url(plugins_url('pinterest.svg', __FILE__ )).'"></a>';
}
...
if ( $nd_learning_meta_box_teacher_social_googleplus == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_googleplus.'"><img alt="" width="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.esc_url(plugins_url('googleplus.svg', __FILE__ )).'"></a>';
}
...
if ( $nd_learning_meta_box_teacher_social_youtube == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_youtube.'"><img alt="" width="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.esc_url(plugins_url('youtube.svg', __FILE__ )).'"></a>';
}
...
if ( $nd_learning_meta_box_teacher_social_linkedin == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_linkedin.'"><img alt="" width="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.esc_url(plugins_url('linkedin.svg', __FILE__ )).'"></a>';
}
...
if ( $nd_learning_meta_box_teacher_social_vimeo == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_vimeo.'"><img alt="" width="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.esc_url(plugins_url('vimeo.svg', __FILE__ )).'"></a>';
}
...
if ( $nd_learning_meta_box_teacher_social_behance == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_behance.'"><img alt="" width="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.esc_url(plugins_url('behance.svg', __FILE__ )).'"></a>';
}
...
if ( $nd_learning_meta_box_teacher_social_dribbble == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_dribbble.'"><img alt="" width="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.esc_url(plugins_url('dribbble.svg', __FILE__ )).'"></a>';
}
...
if ( $nd_learning_meta_box_teacher_social_github == '' ) { 
	...
	$nd_learning_social_teacher_output .= '<a target="_blank" href="'.$nd_learning_meta_box_teacher_social_github.'"><img alt="" width="15" class="nd_learning_margin_right_10 nd_learning_float_left" src="'.esc_url(plugins_url('github.svg', __FILE__ )).'"></a>';
}
