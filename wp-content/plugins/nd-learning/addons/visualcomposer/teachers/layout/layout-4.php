        ...
        <div class="nd_learning_section">
            ...
            <div class="nd_learning_float_left nd_learning_width_65_percentage nd_learning_width_100_percentage_all_iphone">
                ...
                <div class="nd_learning_section nd_learning_padding_left_20 nd_learning_padding_left_0_all_iphone nd_learning_box_sizing_border_box">
                    ...
                    <h2 class="'.$nd_learning_white_title.' nd_learning_margin_top_20_all_iphone "><strong>'.$nd_learning_title .'</strong></h2>
	                ...
	                <div class="nd_learning_section nd_learning_height_15"></div> 
	                <a class="nd_learning_display_inline_block nd_options_color_grey nd_options_border_1_solid_grey nd_options_first_font nd_learning_padding_8 nd_learning_border_radius_3 nd_learning_font_size_13" href="'.$nd_learning_permalink.'">'.__('VIEW PROFILE','nd-learning').'</a>
