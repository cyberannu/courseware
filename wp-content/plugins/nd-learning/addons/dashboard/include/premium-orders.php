...
//create Menu
add_action('nd_learning_add_menu_settings','nd_learning_add_orders_page');
function nd_learning_add_orders_page(){

  add_submenu_page( 'nd-learning-settings','ND Premium Orders', __('Premium Orders','nd-learning'), 'manage_options', 'nd-learning-premium-orders-page', 'nd_learning_premium_orders_page' );
...
//nd_learning_premium_orders
class nd_learning_premium_orders extends WP_List_Table
{
  


  //prepare all orders
  function nd_learning_prepare_premium_orders()
  {
  ...
  function get_columns()
  {
    $nd_learning_columns = array(
      ...
      'course_price' => __('Price','nd-learning'),
      'date' => __('Date','nd-learning'),
      #'qnt' => 'qnt',
      'paypal_payment_status' => __('Payment Status','nd-learning'),
...
//nd_learning_premium_orders_page
function nd_learning_premium_orders_page()
{
  
  $nd_learning_table = new nd_learning_premium_orders();
  $nd_learning_table->nd_learning_prepare_premium_orders();
    ...
    if ( isset($_POST['nd_learning_edit_record']) ) {
      ...
      $nd_learning_edit_record = $wpdb->update( 
        ...
        array( 
          ...
          'course_price' => sanitize_text_field($_POST['nd_learning_order_info_course_price']),
          'date' => sanitize_text_field($_POST['nd_learning_order_info_date']),
          'paypal_payment_status' => sanitize_text_field($_POST['nd_learning_order_info_paypal_payment_status']), 
          'paypal_email' => sanitize_email($_POST['nd_learning_order_info_paypal_email']),
          'paypal_tx' => sanitize_text_field($_POST['nd_learning_order_info_paypal_tx']),
        ...
        <form method="POST">
          <table class="form-table">
            <tbody>
              ...
              <tr>
                <th scope="row">
                  <label>'.__('Course Price','nd-learning').'</label>
                </th>
                <td>
              <input name="nd_learning_order_info_course_price" class="regular-text" type="text" value="'.$nd_learning_order_info->course_price.'">
              </td>
              </tr>
              ...
              <tr>
                <th scope="row">
                  <label>'.__('Paypal Payment Status','nd-learning').'</label>
                </th>
                <td>
              <input name="nd_learning_order_info_paypal_payment_status" class="regular-text" type="text" value="'.$nd_learning_order_info->paypal_payment_status.'">
              </td>
              </tr>
              ...
              <tr>
                <th scope="row">
                  <label>'.__('Paypal Email','nd-learning').'</label>
                </th>
                <td>
              <input name="nd_learning_order_info_paypal_email" class="regular-text" type="text" value="'.$nd_learning_order_info->paypal_email.'">
              </td>
              </tr>

              <tr>
                <th scope="row">
                  <label>'.__('Paypal Transition','nd-learning').'</label>
                </th>
                <td>
              <input name="nd_learning_order_info_paypal_tx" class="regular-text" type="text" value="'.$nd_learning_order_info->paypal_tx.'">
              </td>
              </tr>
  ...
  //DISPLAY ALL ORDERS
    ...
    echo '<div class="wrap">';
    echo '<h2>'.__('Premium Orders','nd-learning').'</h2>';   
