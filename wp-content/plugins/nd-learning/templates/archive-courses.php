...
//display
$nd_learning_customizer_archive_courses_header_image_display = get_option( 'nd_learning_customizer_archive_courses_header_image_display' );
if ( $nd_learning_customizer_archive_courses_header_image_display == '' ) { $nd_learning_customizer_archive_courses_header_image_display = 0;  }
...
if ( $nd_learning_customizer_archive_courses_header_image_display != 1 ) { 

	//header image
	$nd_learning_customizer_archive_courses_header_image = get_option( 'nd_learning_customizer_archive_courses_header_image' );
	if ( $nd_learning_customizer_archive_courses_header_image == '' ) { 
	    $nd_learning_customizer_archive_courses_header_image = '';  
	}else{
	    $nd_learning_customizer_archive_courses_header_image = wp_get_attachment_url($nd_learning_customizer_archive_courses_header_image);
	}

	//position
	$nd_learning_customizer_archive_courses_header_image_position = get_option( 'nd_learning_customizer_archive_courses_header_image_position' );
	if ( $nd_learning_customizer_archive_courses_header_image_position == '' ) { 
	    $nd_learning_customizer_archive_courses_header_image_position = 'nd_learning_background_position_center_top';  
	}

	//get layout
	include "archive-courses-layout/header/".$nd_learning_customizer_archive_courses_layout.".php";
...
//START ARRIVE FORM SEARCH
if( isset($_GET['nd_learning_arrive_from_advsearch']) ) { $nd_learning_arrive_from_advsearch = sanitize_text_field($_GET['nd_learning_arrive_from_advsearch']); } else { $nd_learning_arrive_from_advsearch = ''; }


if ( $nd_learning_arrive_from_advsearch == 'true' ) { 

	//hook
	do_action('nd_learning_archive_courses_search');
