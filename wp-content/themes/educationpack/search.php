    ...
    <div class="nicdark_container nicdark_clearfix">
    	...
    	<?php } ?>
					...
					<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
						...
						<div class="nicdark_section ">
							...
							<div class="nicdark_width_85_percentage nicdark_width_100_percentage_all_iphone nicdark_float_left nicdark_padding_20 nicdark_box_sizing_border_box">
								<h2><a class="nicdark_color_greydark nicdark_first_font" href="<?php the_permalink(); ?>"><?php the_title(); ?></a></h2>
			...
			<?php else: ?>
	            ...
	            <p><?php esc_html_e('NOTHING FOUND: Search again','educationpack'); ?></p>
