...
<div class="nicdark_section nicdark_bg_grey nicdark_border_bottom_1_solid_grey">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="nicdark_grid_12">
            ...
            <h1 class="nicdark_font_size_60 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone"><strong><?php the_title(); ?></strong></h1>
            ...
            <div class="nicdark_section">
                ...
                <?php if(has_tag()) { ?>  
                    ...
                    <div id="nicdark_tags_list" class="nicdark_section">
                         <?php the_tags( esc_html__('Tags : ', 'educationpack'),'',''); ?>
                    </div>
                    <!--END tag-->
                <?php } ?>
